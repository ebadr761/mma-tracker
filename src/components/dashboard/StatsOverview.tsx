...
export default function StatsOverview({
    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
            <div className="bg-card border border-edge rounded-lg p-4 backdrop-blur">
                <div className="flex items-center justify-between">
                    <div>
                        <p className="text-ink-muted text-xs mb-1">Total Hours</p>
            ...
            <div className="bg-card border border-edge rounded-lg p-4 backdrop-blur">
                <div className="flex items-center justify-between">
                    <div>
                        <p className="text-ink-muted text-xs mb-1">Sessions</p>
            ...
            <div className="bg-card border border-edge rounded-lg p-4 backdrop-blur">
                <div className="flex items-center justify-between">
                    <div>
                        <p className="text-ink-muted text-xs mb-1">Avg Intensity</p>
            ...
            <div className="bg-card border border-edge rounded-lg p-4 backdrop-blur">
                <div className="flex items-center justify-between">
                    <div>
                        <p className="text-ink-muted text-xs mb-1">Disciplines</p>
